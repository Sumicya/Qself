...
object QselfCatalog {
    val rows: List<String> = listOf(
        ...
        "qself-purify	appearance	统一净化	entries	界面入口	sumicya.qself.feature.ui.RemoveCameraButton",
        ...
        "qself-notifications	tools	通知管理	filter	提醒过滤	sumicya.qself.feature.notification.MuteQZoneThumbsUp",
        ...
        "qself-appearance	appearance	外观调整	local	局部效果	sumicya.qself.feature.ui.CustomSplash",
        ...
        "qself-appearance	appearance	外观调整	display	显示	sumicya.qself.feature.screenshot.DisableScreenshotShare",
