...
/** Every switch Qself has. One list, shared by the settings app and the code inside QQ. */
object Catalog {
    const val PREFS = "qself"
    const val QQ = "com.tencent.mobileqq"
    /** Settings app → QQ: "send me a report" (ordered broadcast, answered in resultData). */
    ...
    val items = listOf(
        ...
        Item("anti_recall", "防撤回", "丢弃撤回推送，消息留在本地", Group.CHAT),
        ...
        Item("debug_dump", "界面结构导出", "每 3 秒把当前界面结构写到 QQ 自己的 files/qself/ 里，用来适配新版 QQ", Group.DEV, default = false),
    )
